...
from ngmb.models import GAT, GatedGCN, LaplacianEmbeddings
...
class MolTransformerGAPEOther(torch.nn.Module):
    ...
    def forward(self, batch) -> torch.Tensor:
        ...
        pe = self.gape_model[0].forward(input, input_graphs).x()
...
gape_encoding_er = GAT(4, 8, 128, 32)
load_model(gape_encoding_er, "/home/jlagesse/ngmb/mlruns/977078758128412424/445af7e4d35544ebb2aaf73614c8ff04/artifacts/checkpoint.safetensors")
gape_encoding_er  = gape_encoding_er.to(DEVICE).eval()

gape_encoding_pcqm4mv2 = GatedGCN(4, 48, 32)
load_model(gape_encoding_pcqm4mv2, "/home/jlagesse/ngmb/mlruns/945853177701240299/9e38c977e3394244b63063797b00b62a/artifacts/checkpoint.safetensors")
gape_encoding_pcqm4mv2  = gape_encoding_pcqm4mv2.to(DEVICE).eval()

gape_encoding_ogbnarxiv = GatedGCN(4, 48, 32)
load_model(gape_encoding_ogbnarxiv, "/home/jlagesse/ngmb/mlruns/977078758128412424/272a217353c8434387360c2fca44a768/artifacts/checkpoint.safetensors")
